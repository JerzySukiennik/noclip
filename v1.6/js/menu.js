...
@media (max-width:820px){
  .nc-menu{flex-direction:column;align-items:flex-start;justify-content:center;gap:22px;padding:0 24px}
  .nc-col{width:100%}
  .nc-panel{width:min(430px,92vw)}
}
`;
...
export const DEFAULTS = { master: 0.9, music: 0.5, sens: 0.0022, quality: 'med' };
...
export function createMenu(opts) {
  ...
  ]) { el('b', null, keys, k); el('span', null, keys, v); }
