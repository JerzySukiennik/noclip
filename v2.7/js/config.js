...
export const ROOM_TYPES = [
  ...
  T('l94', {
    name: 'LEVEL 94', h: 14.0, weight: 1,
    fog: 0.010, fogColor: 0xbcd4ea, hemiSky: 0xdcecff, hemiGround: 0x7a9a54, hemiI: 1.55, ambient: 0x6a7f8e, ambientI: 0.85,
    lightColor: 0xfff4dd, lightI: 0.0, lightRange: 10.0, lightEvery: 0,
    wall: 'sky', floor: 'grass', ceil: 'sky', gen: 'open', outdoor: true
  }),
  T('pipes', {
